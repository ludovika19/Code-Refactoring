...
public class BankAccountRefactored {
    ...
    // Instead of storing temporary fields, return an object that represents the transfer.
    public WireTransfer initiateWireTransfer(BankAccountRefactored destination, Money amount) {
