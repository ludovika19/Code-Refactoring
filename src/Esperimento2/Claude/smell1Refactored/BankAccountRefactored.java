package Esperimento2.Claude.smell1Refactored;
...
public class BankAccountRefactored {
    ...
    public boolean validateAccountForLoan(Money loanAmount, int creditScore, int yearsOfHistory) {
        ...
        if (isHighLoanAmountWithLowCreditScore(loanAmount, creditScore)) {
            return false;
        }
        return true;
    }

    private boolean isHighLoanAmountWithLowCreditScore(Money loanAmount, int creditScore) {
